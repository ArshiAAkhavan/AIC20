...
public class Constants {
    ...
    public static Integer IO_HANDLER_PORT = 4999;
    public static String IO_READ_ORDER = "R";
    public static String IO_WRITE_ORDER = "W";
    ...
    public static String[] SERVER_RUN_ABDI_COMMAND = {"cd Server", "java -jar server_v1.1.4.jar", "set AICMap=%AICMap%;\"C:\\Users\\nick white\\Desktop\\ai challange 2020\\AIC20-changiz-master\\maps\\3_v1.1.2.map\""};
}
